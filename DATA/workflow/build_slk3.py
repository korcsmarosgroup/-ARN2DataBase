...
from SLKlib import arn_build_new as builder
...
builder.build_base(log=logger, merger_path='merger.db')
builder.build_whole(log=logger, merger_path='merger.db')
builder.build_pth_conns(log=logger, merger_path='merger.db')
...
# sorter.mapper_location = 'casesense_mapper.db'
