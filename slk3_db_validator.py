...
accepted_source_databases = "|".join([
    ...
    "NPInter", "lncRInter", "miRSponge", "StarBase",
    "ARN1Core", "manual curation", "Behrends", "ADB", "Behrends predicted" # ARN DBs
])
...
def validate_db_file(db_path, db_type='basic'):
    ...
    if db_type == 'basic':
        ...
        for layer_table_name in ['SLK_Core', 'layer1', 'PTM', 'ATG_Reg', 'miRNA', 'TF', 'lncRNA']:
