...
DATA_FILE = '../../../SLK_Core/databases/reactome/files/reactome.homo_sapiens.interactions.psi-mitab.txt'
DB_TYPE = 'Reactome'
PATHWAY_FILE_LOCATION = '../../../SLK_Core/databases/reactome/files/pathway_map.txt'
EXPORT_DB_LOCATION = '../../../SLK_Core/output/reactome'
