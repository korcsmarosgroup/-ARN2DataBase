...
with conn:
    ...
    c.execute('''CREATE TABLE SLK_Core (id INT,
    ...
    c.execute('''CREATE TABLE layer1 (id INT,
                                    ...
                                    confidence_scores TEXT,
                                    layer TEXT)''')
    c.execute('''CREATE TABLE PTM (id INT ,
                                    interactor_a_node_id INT,
                                    interactor_b_node_id INT,
                                    interactor_a_node_name TEXT,
                                    interactor_b_node_name TEXT,
                                    ...
                                    confidence_scores TEXT,
                                    layer TEXT)''')
    c.execute('''CREATE TABLE ATG_Reg (id INT ,
                                    interactor_a_node_id INT,
                                    interactor_b_node_id INT,
                                    interactor_a_node_name TEXT,
                                    interactor_b_node_name TEXT,
                                    ...
                                    confidence_scores TEXT,
                                    layer TEXT)''')
    c.execute('''CREATE TABLE miRNA (id INT ,
                                    interactor_a_node_id INT,
                                    interactor_b_node_id INT,
                                    interactor_a_node_name TEXT,
                                    interactor_b_node_name TEXT,
                                    ...
                                    confidence_scores TEXT,
                                    layer TEXT)''')
    c.execute('''CREATE TABLE TF (id INT ,
                                    interactor_a_node_id INT,
                                    interactor_b_node_id INT,
                                    interactor_a_node_name TEXT,
                                    interactor_b_node_name TEXT,
                                    ...
                                    confidence_scores TEXT,
                                    layer TEXT)''')
    c.execute('''CREATE TABLE lncRNA (id INT ,
                                    interactor_a_node_id INT,
                                    interactor_b_node_id INT,
                                    interactor_a_node_name TEXT,
                                    interactor_b_node_name TEXT,
            ...
            if line[-1] == '7':
                if line[4] in l6_nodes or line[3] in l6_nodes:
                    ...
                    c.execute("INSERT INTO lncRNA VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",
                              line)
    # Adding additional edge data based on SLK_Core
    ...
    while num < 7:
        ...
        while True:
            ...
            if row is None:
                ...
                # Only need directedness information from interaction_identifiers of SLK_Core
                if num == 0:
